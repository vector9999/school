			...
			<div class="container">
				<div id="contents">
					...
					<div id="bbs_wrap">
						<div class="total">
							총 예약 수
							<strong><c:out value="${fn:length(resultList)}"/></strong> 건 <!-- list쿼리에서 검색한 총 갯수, totalRecordCount ===> 전체가 아니고 검색한! 조건에 대한 게시물 수를 가져옴, 그래야 페이징 처리가 되기 때문 -->
							...
							<table class="list_table">
								...
								<tbody>
									...
									<c:forEach var="result" items="${resultList}" varStatus="status">
										<tr>
											<td class="num"> <!-- 별도의 페이징이 없이 아래의 계산식 사용 -->
												<c:out value="${fn:length(resultList) - (status.index)}"/> <!-- index(0부터 시작), count(1부터 시작) -->
											</td>
											<td class="tit">
