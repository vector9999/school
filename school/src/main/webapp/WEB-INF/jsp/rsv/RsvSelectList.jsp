		...
		<div id="content">
			<div class="container">
				<div id="contents">
					<!-- 검색영역 -->
					<div id="bbs_search">
						<form name="frm" method="post" action="/rsv/rsvSelectList.do"> <!-- 파라메터를 보내는 것이기 때문에 form으로 감싸져있음, post던 get으로 보내던 상관없음 -->
							<fieldset>
								...
								<tbody>
									...
									<c:forEach var="result" items="${resultList}" varStatus="status">
										<tr>
											...
											<td class="tit">
												<c:url var="updateUrl" value="/rsv/rsvSelect.do${_BASE_PARAM}"> 
