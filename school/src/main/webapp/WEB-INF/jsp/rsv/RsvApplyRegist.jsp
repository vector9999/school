			...
			<div id="content">
				...
				<div id="contents">
					...
					<form action="${actionUrl}" method="post" id="frm" name="frm" onsubmit="return regist()">
						...
						<input type="hidden" name="reqstId" value="${result.resveId}"/>
						<input type="hidden" name="resveDe" value="TYPTE01"/>
...
<script> /* a태그에는 항상 링크가 걸려있어서 혹은 submit 타입의 버튼에서 작용.. return false로 링크 타는 것을 방지하는 것 - 방식은 두가지임 return false, e.preventDefault() 두가지. 같은 기능임. */
