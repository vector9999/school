	    ...
	    <tbody>
	    	<c:forEach var="result" items="${resultList}">
		    	<tr>
		    		...
		    		<td>
		    			<c:url var="viewUrl" value="/temptemp/select.do">
...
<%--     <div id="paging_div">
    	<ul class="paging_align">
    		<c:url var="pageUrl" value="/temptemp/selectList.do"/>
    ...
    <button type="button" id="btn-reg" data-href="/temptemp/tempRegist.do"> <!-- 데이터로 가져오기 위한 data-href. 예전에는 버튼에 데이터 못넣고 웹접근성을 위해 a태그 별도로 썻어야했다 -->
    	등록하기
    </button>
